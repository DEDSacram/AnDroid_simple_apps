...
public final class UIntRange extends UIntProgression implements ClosedRange<UInt> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable value) {
        return m1474containsWZ4Q5Ns(((UInt) value).m390unboximpl());
    }

    public /* bridge */ /* synthetic */ Comparable getEndInclusive() {
        return UInt.m333boximpl(m1475getEndInclusivepVg5ArA());
    }

    public /* bridge */ /* synthetic */ Comparable getStart() {
        return UInt.m333boximpl(m1476getStartpVg5ArA());
    }
    ...
    public boolean m1474containsWZ4Q5Ns(int value) {
        return UnsignedKt.uintCompare(m1470getFirstpVg5ArA(), value) <= 0 && UnsignedKt.uintCompare(value, m1471getLastpVg5ArA()) <= 0;
    }

    public boolean isEmpty() {
        return UnsignedKt.uintCompare(m1470getFirstpVg5ArA(), m1471getLastpVg5ArA()) > 0;
    }

    public boolean equals(Object other) {
        return (other instanceof UIntRange) && ((isEmpty() && ((UIntRange) other).isEmpty()) || (m1470getFirstpVg5ArA() == ((UIntRange) other).m1470getFirstpVg5ArA() && m1471getLastpVg5ArA() == ((UIntRange) other).m1471getLastpVg5ArA()));
    }
    ...
    public String toString() {
        return UInt.m384toStringimpl(m1470getFirstpVg5ArA()) + ".." + UInt.m384toStringimpl(m1471getLastpVg5ArA());
    }
