...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1552minusLRDsOJo(long duration) {
        return TimeMark.DefaultImpls.m1696minusLRDsOJo(this, duration);
    }

    /* renamed from: getAdjustment-UwyO8pc  reason: not valid java name */
    public final long m1551getAdjustmentUwyO8pc() {
    ...
    public long m1550elapsedNowUwyO8pc() {
        return Duration.m1593minusLRDsOJo(this.mark.m1693elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1553plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m1594plusLRDsOJo(this.adjustment, duration), (DefaultConstructorMarker) null);
    }
}
