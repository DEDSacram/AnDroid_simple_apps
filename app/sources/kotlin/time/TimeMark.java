...
public interface TimeMark {
    ...
    TimeMark m1694minusLRDsOJo(long j);

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    TimeMark m1695plusLRDsOJo(long j);

    @Metadata(k = 3, mv = {1, 7, 1}, xi = 48)
    /* compiled from: TimeSource.kt */
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1697plusLRDsOJo(TimeMark $this, long duration) {
            return new AdjustedTimeMark($this, duration, (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-LRDsOJo  reason: not valid java name */
        public static TimeMark m1696minusLRDsOJo(TimeMark $this, long duration) {
            return $this.m1695plusLRDsOJo(Duration.m1610unaryMinusUwyO8pc(duration));
        }

        public static boolean hasPassedNow(TimeMark $this) {
            return !Duration.m1591isNegativeimpl($this.m1693elapsedNowUwyO8pc());
        }
