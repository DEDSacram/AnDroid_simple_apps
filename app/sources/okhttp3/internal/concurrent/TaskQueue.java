...
public final class TaskQueue {
    ...
    public final void schedule(okhttp3.internal.concurrent.Task r6, long r7) {
        /*
            ...
            monitor-enter(r0)
            r1 = 0
            boolean r2 = r5.getShutdown$okhttp()     // Catch:{ all -> 0x0060 }
            if (r2 == 0) goto L_0x004d
            boolean r2 = r6.getCancelable()     // Catch:{ all -> 0x0060 }
            if (r2 == 0) goto L_0x0030
            r2 = 0
            okhttp3.internal.concurrent.TaskRunner$Companion r3 = okhttp3.internal.concurrent.TaskRunner.Companion     // Catch:{ all -> 0x0060 }
            java.util.logging.Logger r3 = r3.getLogger()     // Catch:{ all -> 0x0060 }
            java.util.logging.Level r4 = java.util.logging.Level.FINE     // Catch:{ all -> 0x0060 }
            boolean r3 = r3.isLoggable(r4)     // Catch:{ all -> 0x0060 }
            if (r3 == 0) goto L_0x002c
            r3 = 0
            java.lang.String r4 = "schedule canceled (queue is shutdown)"
            okhttp3.internal.concurrent.TaskLoggerKt.log(r6, r5, r4)     // Catch:{ all -> 0x0060 }
        L_0x002c:
            monitor-exit(r0)
            return
        L_0x0030:
        ...
        L_0x004d:
            r2 = 0
            boolean r2 = r5.scheduleAndDecide$okhttp(r6, r7, r2)     // Catch:{ all -> 0x0060 }
            if (r2 == 0) goto L_0x005b
            okhttp3.internal.concurrent.TaskRunner r2 = r5.getTaskRunner$okhttp()     // Catch:{ all -> 0x0060 }
            r2.kickCoordinator$okhttp(r5)     // Catch:{ all -> 0x0060 }
        L_0x005b:
    ...
    public static /* synthetic */ void schedule$default(TaskQueue taskQueue, String name2, long delayNanos, Function0 block, int i, Object obj) {
        ...
        taskQueue.schedule(new TaskQueue$schedule$2(name2, block), delayNanos);
    }

    public final void schedule(String name2, long delayNanos, Function0<Long> block) {
        Intrinsics.checkNotNullParameter(name2, "name");
        Intrinsics.checkNotNullParameter(block, "block");
        schedule(new TaskQueue$schedule$2(name2, block), delayNanos);
    }
    ...
    public static /* synthetic */ void execute$default(TaskQueue taskQueue, String name2, long delayNanos, boolean cancelable, Function0 block, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(name2, "name");
        Intrinsics.checkNotNullParameter(block, "block");
        taskQueue.schedule(new TaskQueue$execute$1(name2, cancelable, block), delayNanos);
    }

    public final void execute(String name2, long delayNanos, boolean cancelable, Function0<Unit> block) {
        Intrinsics.checkNotNullParameter(name2, "name");
        Intrinsics.checkNotNullParameter(block, "block");
        schedule(new TaskQueue$execute$1(name2, cancelable, block), delayNanos);
    }
    ...
    public final boolean scheduleAndDecide$okhttp(Task task, long delayNanos, boolean recurrence) {
        ...
        if (TaskRunner.Companion.getLogger().isLoggable(Level.FINE)) {
            if (recurrence) {
                str = Intrinsics.stringPlus("run again after ", TaskLoggerKt.formatDuration(executeNanoTime - now));
            } else {
                str = Intrinsics.stringPlus("scheduled after ", TaskLoggerKt.formatDuration(executeNanoTime - now));
            }
