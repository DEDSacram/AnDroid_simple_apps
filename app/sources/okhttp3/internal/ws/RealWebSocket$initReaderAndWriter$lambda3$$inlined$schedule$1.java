...
public final class RealWebSocket$initReaderAndWriter$lambda3$$inlined$schedule$1 extends Task {
    ...
    public RealWebSocket$initReaderAndWriter$lambda3$$inlined$schedule$1(String $name2, RealWebSocket realWebSocket, long j) {
        super($name2, false, 2, (DefaultConstructorMarker) null);
        this.$name = $name2;
