...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    private final boolean isAscii(String $this$isAscii) {
        return $this$isAscii.length() == ((int) Utf8.size$default($this$isAscii, 0, 0, 3, (Object) null));
    }
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        ...
        if (!(charSequence == null || charSequence.length() == 0)) {
            if (!StringsKt.startsWith$default(hostname2, ".", false, 2, (Object) null)) {
                if (!StringsKt.endsWith$default(hostname2, "..", false, 2, (Object) null)) {
                    CharSequence charSequence2 = pattern2;
                    if (!(charSequence2 == null || charSequence2.length() == 0)) {
                        if (!StringsKt.startsWith$default(pattern2, ".", false, 2, (Object) null)) {
