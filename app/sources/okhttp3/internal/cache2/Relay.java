...
public final class Relay {
    ...
    public final void writeHeader(ByteString prefix, long upstreamSize, long metadataSize) throws IOException {
        ...
        Buffer $this$writeHeader_u24lambda_u2d0 = header;
        ...
        if ($this$writeHeader_u24lambda_u2d0.size() == FILE_HEADER_SIZE) {
            ...
            new FileOperator(channel).write(0, header, FILE_HEADER_SIZE);
            return;
        }
    ...
    public final class RelaySource implements Source {
        ...
        public RelaySource(Relay this$02) {
            Intrinsics.checkNotNullParameter(this$02, "this$0");
            this.this$0 = this$02;
            RandomAccessFile file = this$02.getFile();
        ...
        public long read(okio.Buffer r25, long r26) throws java.io.IOException {
            ...
            L_0x0014:
                ...
                r0 = 0
            L_0x001a:
                long r5 = r11.getUpstreamPos()     // Catch:{ all -> 0x01a3 }
                long r7 = r1.sourcePos     // Catch:{ all -> 0x01a3 }
                int r7 = (r7 > r5 ? 1 : (r7 == r5 ? 0 : -1))
                r8 = 2
                r12 = -1
                if (r7 == 0) goto L_0x0060
                long r4 = r11.getUpstreamPos()     // Catch:{ all -> 0x01a3 }
                okio.Buffer r6 = r11.getBuffer()     // Catch:{ all -> 0x01a3 }
                long r6 = r6.size()     // Catch:{ all -> 0x01a3 }
                long r14 = r4 - r6
                long r4 = r1.sourcePos     // Catch:{ all -> 0x01a3 }
            ...
            L_0x003e:
                long r4 = r11.getUpstreamPos()     // Catch:{ all -> 0x01a3 }
                long r6 = r1.sourcePos     // Catch:{ all -> 0x01a3 }
                long r4 = r4 - r6
                long r4 = java.lang.Math.min(r2, r4)     // Catch:{ all -> 0x01a3 }
                r12 = r4
                okio.Buffer r4 = r11.getBuffer()     // Catch:{ all -> 0x01a3 }
                long r5 = r1.sourcePos     // Catch:{ all -> 0x01a3 }
                long r6 = r5 - r14
                r5 = r25
                r8 = r12
                r4.copyTo((okio.Buffer) r5, (long) r6, (long) r8)     // Catch:{ all -> 0x01a3 }
                long r4 = r1.sourcePos     // Catch:{ all -> 0x01a3 }
                long r4 = r4 + r12
                r1.sourcePos = r4     // Catch:{ all -> 0x01a3 }
                monitor-exit(r11)
                return r12
            L_0x0060:
                boolean r7 = r11.getComplete()     // Catch:{ all -> 0x01a3 }
                if (r7 == 0) goto L_0x0068
                monitor-exit(r11)
                return r12
            L_0x0068:
                java.lang.Thread r7 = r11.getUpstreamReader()     // Catch:{ all -> 0x01a3 }
                if (r7 == 0) goto L_0x0074
                okio.Timeout r7 = r1.timeout     // Catch:{ all -> 0x01a3 }
                r7.waitUntilNotified(r11)     // Catch:{ all -> 0x01a3 }
                goto L_0x001a
            L_0x0074:
                java.lang.Thread r7 = java.lang.Thread.currentThread()     // Catch:{ all -> 0x01a3 }
                r11.setUpstreamReader(r7)     // Catch:{ all -> 0x01a3 }
            L_0x007c:
                monitor-exit(r11)
                r11 = r4
                r14 = 32
            ...
            L_0x00a3:
                r8 = 0
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x018a }
                okio.Source r0 = r0.getUpstream()     // Catch:{ all -> 0x018a }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x018a }
                okhttp3.internal.cache2.Relay r4 = r1.this$0     // Catch:{ all -> 0x018a }
                okio.Buffer r4 = r4.getUpstreamBuffer()     // Catch:{ all -> 0x018a }
                okhttp3.internal.cache2.Relay r5 = r1.this$0     // Catch:{ all -> 0x018a }
                long r5 = r5.getBufferMaxSize()     // Catch:{ all -> 0x018a }
                long r4 = r0.read(r4, r5)     // Catch:{ all -> 0x018a }
                r6 = r4
                int r0 = (r6 > r12 ? 1 : (r6 == r12 ? 0 : -1))
                if (r0 != 0) goto L_0x00e5
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x018a }
                long r4 = r0.getUpstreamPos()     // Catch:{ all -> 0x018a }
                r0.commit(r4)     // Catch:{ all -> 0x018a }
                okhttp3.internal.cache2.Relay r4 = r1.this$0
                monitor-enter(r4)
                r0 = 0
                r4.setUpstreamReader(r8)     // Catch:{ all -> 0x00e2 }
                r5 = r4
                r8 = 0
                r9 = r5
                java.lang.Object r9 = (java.lang.Object) r9     // Catch:{ all -> 0x00e2 }
                r9.notifyAll()     // Catch:{ all -> 0x00e2 }
            ...
            L_0x00e2:
                ...
                throw r0
            L_0x00e5:
                long r4 = java.lang.Math.min(r6, r2)     // Catch:{ all -> 0x018a }
                r12 = r4
                okhttp3.internal.cache2.Relay r0 = r1.this$0     // Catch:{ all -> 0x018a }
                okio.Buffer r4 = r0.getUpstreamBuffer()     // Catch:{ all -> 0x018a }
                r16 = 0
                r5 = r25
                r22 = r6
                r6 = r16
                r8 = r12
                r4.copyTo((okio.Buffer) r5, (long) r6, (long) r8)     // Catch:{ all -> 0x0187 }
                long r4 = r1.sourcePos     // Catch:{ all -> 0x0187 }
                long r4 = r4 + r12
                r1.sourcePos = r4     // Catch:{ all -> 0x0187 }
                okhttp3.internal.cache2.FileOperator r0 = r1.fileOperator     // Catch:{ all -> 0x0187 }
                kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x0187 }
                okhttp3.internal.cache2.Relay r4 = r1.this$0     // Catch:{ all -> 0x0187 }
                long r4 = r4.getUpstreamPos()     // Catch:{ all -> 0x0187 }
                long r17 = r4 + r14
                okhttp3.internal.cache2.Relay r4 = r1.this$0     // Catch:{ all -> 0x0187 }
                okio.Buffer r4 = r4.getUpstreamBuffer()     // Catch:{ all -> 0x0187 }
                okio.Buffer r19 = r4.clone()     // Catch:{ all -> 0x0187 }
                r16 = r0
                r20 = r22
                r16.write(r17, r19, r20)     // Catch:{ all -> 0x0187 }
                okhttp3.internal.cache2.Relay r4 = r1.this$0     // Catch:{ all -> 0x0187 }
                monitor-enter(r4)     // Catch:{ all -> 0x0187 }
                r0 = 0
                okio.Buffer r5 = r4.getBuffer()     // Catch:{ all -> 0x017f }
                okio.Buffer r6 = r4.getUpstreamBuffer()     // Catch:{ all -> 0x017f }
                r7 = r22
                r5.write((okio.Buffer) r6, (long) r7)     // Catch:{ all -> 0x017c }
                okio.Buffer r5 = r4.getBuffer()     // Catch:{ all -> 0x017c }
                long r5 = r5.size()     // Catch:{ all -> 0x017c }
                long r14 = r4.getBufferMaxSize()     // Catch:{ all -> 0x017c }
                int r5 = (r5 > r14 ? 1 : (r5 == r14 ? 0 : -1))
                if (r5 <= 0) goto L_0x0155
                okio.Buffer r5 = r4.getBuffer()     // Catch:{ all -> 0x017c }
                okio.Buffer r6 = r4.getBuffer()     // Catch:{ all -> 0x017c }
                long r14 = r6.size()     // Catch:{ all -> 0x017c }
                long r16 = r4.getBufferMaxSize()     // Catch:{ all -> 0x017c }
                long r14 = r14 - r16
                r5.skip(r14)     // Catch:{ all -> 0x017c }
            L_0x0155:
                long r5 = r4.getUpstreamPos()     // Catch:{ all -> 0x017c }
                long r5 = r5 + r7
                r4.setUpstreamPos(r5)     // Catch:{ all -> 0x017c }
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x017c }
                monitor-exit(r4)     // Catch:{ all -> 0x0187 }
                okhttp3.internal.cache2.Relay r4 = r1.this$0
                monitor-enter(r4)
                r0 = 0
                r5 = 0
                r4.setUpstreamReader(r5)     // Catch:{ all -> 0x0179 }
                r5 = r4
                r6 = 0
                r9 = r5
                java.lang.Object r9 = (java.lang.Object) r9     // Catch:{ all -> 0x0179 }
                r9.notifyAll()     // Catch:{ all -> 0x0179 }
                kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0179 }
                monitor-exit(r4)
                r4 = r12
                r6 = r7
                return r12
            ...
            L_0x017f:
                ...
                r5 = 0
            L_0x0183:
                monitor-exit(r4)     // Catch:{ all -> 0x0185 }
            ...
            L_0x018c:
                ...
                monitor-enter(r4)
                r6 = 0
                r4.setUpstreamReader(r5)     // Catch:{ all -> 0x01a0 }
                r5 = r4
                r7 = 0
                r8 = r5
                java.lang.Object r8 = (java.lang.Object) r8     // Catch:{ all -> 0x01a0 }
                r8.notifyAll()     // Catch:{ all -> 0x01a0 }
                kotlin.Unit r5 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x01a0 }
                monitor-exit(r4)
                throw r0
            L_0x01a0:
                r0 = move-exception
