...
public class Platform {
    ...
    public X509TrustManager trustManager(SSLSocketFactory sslSocketFactory) {
        ...
        try {
            ...
            if (Intrinsics.areEqual((Object) e2.getClass().getName(), (Object) "java.lang.reflect.InaccessibleObjectException")) {
    ...
    public SSLSocketFactory newSslSocketFactory(X509TrustManager trustManager) {
        ...
        try {
            ...
            $this$newSslSocketFactory_u24lambda_u2d1.init((KeyManager[]) null, new TrustManager[]{trustManager}, (SecureRandom) null);
