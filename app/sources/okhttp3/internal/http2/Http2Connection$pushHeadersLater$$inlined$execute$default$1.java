...
public final class Http2Connection$pushHeadersLater$$inlined$execute$default$1 extends Task {
    ...
    public Http2Connection$pushHeadersLater$$inlined$execute$default$1(String $name2, boolean $cancelable2, Http2Connection http2Connection, int i, List list, boolean z) {
    ...
    public long runOnce() {
        ...
        L_0x002c:
            ...
            r5 = 0
            okhttp3.internal.http2.Http2Connection r6 = r8.this$0     // Catch:{ all -> 0x0042 }
            java.util.Set r6 = r6.currentPushRequests     // Catch:{ all -> 0x0042 }
            int r7 = r8.$streamId$inlined     // Catch:{ all -> 0x0042 }
            java.lang.Integer r7 = java.lang.Integer.valueOf(r7)     // Catch:{ all -> 0x0042 }
            r6.remove(r7)     // Catch:{ all -> 0x0042 }
