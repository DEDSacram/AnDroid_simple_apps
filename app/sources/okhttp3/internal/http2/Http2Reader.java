...
public final class Http2Reader implements Closeable {
    ...
    public final void readConnectionPreface(Handler handler) throws IOException {
        ...
        if (!this.client) {
            ...
            if (logger2.isLoggable(Level.FINE)) {
                logger2.fine(Util.format(Intrinsics.stringPlus("<< CONNECTION ", connectionPreface.hex()), new Object[0]));
            }
    ...
    private final void readPriority(Handler handler, int streamId) throws IOException {
        ...
        handler.priority(streamId, Integer.MAX_VALUE & w1, Util.and(this.source.readByte(), 255) + 1, (Integer.MIN_VALUE & w1) != 0);
    }
