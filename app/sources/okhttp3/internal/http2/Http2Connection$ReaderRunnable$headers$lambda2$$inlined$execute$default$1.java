...
public final class Http2Connection$ReaderRunnable$headers$lambda2$$inlined$execute$default$1 extends Task {
    ...
    public Http2Connection$ReaderRunnable$headers$lambda2$$inlined$execute$default$1(String $name2, boolean $cancelable2, Http2Connection http2Connection, Http2Stream http2Stream) {
