...
public final class Http2Connection$pushResetLater$$inlined$execute$default$1 extends Task {
    ...
    public Http2Connection$pushResetLater$$inlined$execute$default$1(String $name2, boolean $cancelable2, Http2Connection http2Connection, int i, ErrorCode errorCode) {
