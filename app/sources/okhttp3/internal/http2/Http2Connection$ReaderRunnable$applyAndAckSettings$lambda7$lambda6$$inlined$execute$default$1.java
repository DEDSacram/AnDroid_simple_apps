...
public final class Http2Connection$ReaderRunnable$applyAndAckSettings$lambda7$lambda6$$inlined$execute$default$1 extends Task {
    ...
    public Http2Connection$ReaderRunnable$applyAndAckSettings$lambda7$lambda6$$inlined$execute$default$1(String $name2, boolean $cancelable2, Http2Connection http2Connection, Ref.ObjectRef objectRef) {
