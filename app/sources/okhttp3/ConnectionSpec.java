...
public final class ConnectionSpec {
    ...
    public final List<CipherSuite> m1826deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m1828deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean m1827deprecated_supportsTlsExtensions() {
        return this.supportsTlsExtensions;
    }
    ...
    public int hashCode() {
        ...
        String[] strArr = this.cipherSuitesAsString;
        int i2 = 0;
        int result = (i + (strArr == null ? 0 : Arrays.hashCode(strArr))) * 31;
    ...
    public static final class Builder {
        ...
        public final Builder allEnabledCipherSuites() {
            ...
            if ($this$allEnabledCipherSuites_u24lambda_u2d1.getTls$okhttp()) {
                $this$allEnabledCipherSuites_u24lambda_u2d1.setCipherSuites$okhttp((String[]) null);
                return this;
            }
        ...
        public final Builder cipherSuites(String... cipherSuites2) {
            ...
            if ($this$cipherSuites_u24lambda_u2d7.getTls$okhttp()) {
                if (!(cipherSuites2.length == 0)) {
                    $this$cipherSuites_u24lambda_u2d7.setCipherSuites$okhttp((String[]) cipherSuites2.clone());
                    return this;
                }
        ...
        public final Builder allEnabledTlsVersions() {
            ...
            if ($this$allEnabledTlsVersions_u24lambda_u2d9.getTls$okhttp()) {
                $this$allEnabledTlsVersions_u24lambda_u2d9.setTlsVersions$okhttp((String[]) null);
                return this;
            }
        ...
        public final Builder tlsVersions(String... tlsVersions2) {
            ...
            if ($this$tlsVersions_u24lambda_u2d15.getTls$okhttp()) {
                if (!(tlsVersions2.length == 0)) {
                    $this$tlsVersions_u24lambda_u2d15.setTlsVersions$okhttp((String[]) tlsVersions2.clone());
                    return this;
                }
        ...
        public final Builder supportsTlsExtensions(boolean supportsTlsExtensions2) {
            ...
            if ($this$supportsTlsExtensions_u24lambda_u2d17.getTls$okhttp()) {
                $this$supportsTlsExtensions_u24lambda_u2d17.setSupportsTlsExtensions$okhttp(supportsTlsExtensions2);
                return this;
            }
