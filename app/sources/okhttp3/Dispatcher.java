...
public final class Dispatcher {
    ...
    public final void setMaxRequests(int maxRequests2) {
        ...
        throw new IllegalArgumentException(Intrinsics.stringPlus("max < 1: ", Integer.valueOf(maxRequests2)).toString());
    }
    ...
    public final void setMaxRequestsPerHost(int maxRequestsPerHost2) {
        ...
        throw new IllegalArgumentException(Intrinsics.stringPlus("max < 1: ", Integer.valueOf(maxRequestsPerHost2)).toString());
    }
    ...
    public final ExecutorService m1838deprecated_executorService() {
        return executorService();
    }
}
