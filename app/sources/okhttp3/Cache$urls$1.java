...
public final class Cache$urls$1 implements Iterator<String>, KMutableIterator {
    ...
    public boolean hasNext() {
        ...
        L_0x0009:
            ...
            java.util.Iterator<okhttp3.internal.cache.DiskLruCache$Snapshot> r2 = r8.delegate     // Catch:{ IOException -> 0x0039 }
            ...
            r5 = 0
            okio.Source r6 = r4.getSource(r0)     // Catch:{ all -> 0x0032 }
            okio.BufferedSource r6 = okio.Okio.buffer((okio.Source) r6)     // Catch:{ all -> 0x0032 }
            java.lang.String r7 = r6.readUtf8LineStrict()     // Catch:{ all -> 0x0032 }
            r8.nextUrl = r7     // Catch:{ all -> 0x0032 }
