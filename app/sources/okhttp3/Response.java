...
public final class Response implements Closeable {
    ...
    public final Request m1927deprecated_request() {
        return this.request;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "protocol", imports = {}))
    /* renamed from: -deprecated_protocol  reason: not valid java name */
    public final Protocol m1925deprecated_protocol() {
        return this.protocol;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "code", imports = {}))
    /* renamed from: -deprecated_code  reason: not valid java name */
    public final int m1919deprecated_code() {
        return this.code;
    }
    ...
    public final String m1922deprecated_message() {
        return this.message;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "handshake", imports = {}))
    /* renamed from: -deprecated_handshake  reason: not valid java name */
    public final Handshake m1920deprecated_handshake() {
        return this.handshake;
    }
    ...
    public final Headers m1921deprecated_headers() {
        return this.headers;
    }
    ...
    public final ResponseBody m1916deprecated_body() {
        return this.body;
    }
    ...
    public final Response m1923deprecated_networkResponse() {
        return this.networkResponse;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "cacheResponse", imports = {}))
    /* renamed from: -deprecated_cacheResponse  reason: not valid java name */
    public final Response m1918deprecated_cacheResponse() {
        return this.cacheResponse;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "priorResponse", imports = {}))
    /* renamed from: -deprecated_priorResponse  reason: not valid java name */
    public final Response m1924deprecated_priorResponse() {
        return this.priorResponse;
    }
    ...
    public final CacheControl m1917deprecated_cacheControl() {
        return cacheControl();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "sentRequestAtMillis", imports = {}))
    /* renamed from: -deprecated_sentRequestAtMillis  reason: not valid java name */
    public final long m1928deprecated_sentRequestAtMillis() {
        return this.sentRequestAtMillis;
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = "receivedResponseAtMillis", imports = {}))
    /* renamed from: -deprecated_receivedResponseAtMillis  reason: not valid java name */
    public final long m1926deprecated_receivedResponseAtMillis() {
        return this.receivedResponseAtMillis;
    }
    ...
    public static class Builder {
        ...
        public Builder body(ResponseBody body2) {
            setBody$okhttp(body2);
            return this;
        }

        public Builder networkResponse(Response networkResponse2) {
            Builder $this$networkResponse_u24lambda_u2d10 = this;
            $this$networkResponse_u24lambda_u2d10.checkSupportResponse("networkResponse", networkResponse2);
            $this$networkResponse_u24lambda_u2d10.setNetworkResponse$okhttp(networkResponse2);
            return this;
        }

        public Builder cacheResponse(Response cacheResponse2) {
            Builder $this$cacheResponse_u24lambda_u2d11 = this;
            $this$cacheResponse_u24lambda_u2d11.checkSupportResponse("cacheResponse", cacheResponse2);
            $this$cacheResponse_u24lambda_u2d11.setCacheResponse$okhttp(cacheResponse2);
            return this;
        }

        private final void checkSupportResponse(String name, Response response) {
            if (response != null) {
                Response $this$checkSupportResponse_u24lambda_u2d16 = response;
                boolean z = true;
        ...
        public Builder priorResponse(Response priorResponse2) {
            ...
            $this$priorResponse_u24lambda_u2d17.checkPriorResponse(priorResponse2);
            $this$priorResponse_u24lambda_u2d17.setPriorResponse$okhttp(priorResponse2);
            return this;
        }
        ...
        public Builder sentRequestAtMillis(long sentRequestAtMillis2) {
            setSentRequestAtMillis$okhttp(sentRequestAtMillis2);
            return this;
        }

        public Builder receivedResponseAtMillis(long receivedResponseAtMillis2) {
            setReceivedResponseAtMillis$okhttp(receivedResponseAtMillis2);
            return this;
        }
