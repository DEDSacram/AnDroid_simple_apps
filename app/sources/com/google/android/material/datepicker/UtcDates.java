...
class UtcDates {
    ...
    static SimpleDateFormat getTextInputFormat() {
        SimpleDateFormat format = new SimpleDateFormat(((SimpleDateFormat) java.text.DateFormat.getDateInstance(3, Locale.getDefault())).toPattern().replaceAll("\\s+", HttpUrl.FRAGMENT_ENCODE_SET), Locale.getDefault());
        format.setTimeZone(getTimeZone());
