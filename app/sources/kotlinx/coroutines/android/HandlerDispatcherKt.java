...
public final class HandlerDispatcherKt {
    ...
    static {
        ...
        try {
            ...
            obj = Result.m245constructorimpl(new HandlerContext(asHandler(Looper.getMainLooper(), true), (String) null, 2, (DefaultConstructorMarker) null));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.Companion;
            obj = Result.m245constructorimpl(ResultKt.createFailure(th));
        }
    ...
    public static final void m1730postFrameCallback$lambda6(CancellableContinuation $cont, long nanos) {
