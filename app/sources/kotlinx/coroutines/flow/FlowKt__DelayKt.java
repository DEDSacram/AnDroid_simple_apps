...
final /* synthetic */ class FlowKt__DelayKt {
    ...
    public static final <T> Flow<T> m1770debounceHG0u8IE(Flow<? extends T> $this$debounce, long timeout) {
        return FlowKt.debounce($this$debounce, DelayKt.m1723toDelayMillisLRDsOJo(timeout));
    }
    ...
    public static final <T> Flow<T> m1771sampleHG0u8IE(Flow<? extends T> $this$sample, long period) {
        return FlowKt.sample($this$sample, DelayKt.m1723toDelayMillisLRDsOJo(period));
    }
}
