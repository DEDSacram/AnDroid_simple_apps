...
public interface ReceiveChannel<E> {
    ...
    Object m1762receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk  reason: not valid java name */
    Object m1763tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) {
            Object result = receiveChannel.m1763tryReceivePtdJZtk();
            if (ChannelResult.m1753isSuccessimpl(result)) {
                return ChannelResult.m1749getOrThrowimpl(result);
            }
            Throwable r1 = ChannelResult.m1747exceptionOrNullimpl(result);
            if (r1 == null) {
                return null;
            }
        ...
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r3, kotlin.coroutines.Continuation<? super E> r4) {
            ...
            L_0x002d:
                ...
                java.lang.Object r3 = r3.m1755unboximpl()
                goto L_0x0045
            L_0x0038:
                kotlin.ResultKt.throwOnFailure(r0)
                r2 = 1
                r4.label = r2
                java.lang.Object r3 = r3.m1762receiveCatchingJP2dKIU(r4)
                if (r3 != r1) goto L_0x0045
                return r1
            L_0x0045:
                java.lang.Object r3 = kotlinx.coroutines.channels.ChannelResult.m1748getOrNullimpl(r3)
                return r3
            */
