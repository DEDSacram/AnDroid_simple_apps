...
public class ArrayChannel<E> extends AbstractChannel<E> {
    ...
    public java.lang.Object pollSelectInternal(kotlinx.coroutines.selects.SelectInstance<?> r14) {
        /*
            ...
            r5.lock()
            r6 = 0
            int r7 = r13.size     // Catch:{ all -> 0x00cf }
            if (r7 != 0) goto L_0x001d
            kotlinx.coroutines.channels.Closed r8 = r13.getClosedForSend()     // Catch:{ all -> 0x00cf }
            if (r8 != 0) goto L_0x0019
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00cf }
        L_0x0019:
            r5.unlock()
            return r8
        L_0x001d:
            java.lang.Object[] r8 = r13.buffer     // Catch:{ all -> 0x00cf }
            int r9 = r13.head     // Catch:{ all -> 0x00cf }
            r10 = r8[r9]     // Catch:{ all -> 0x00cf }
            r2 = r10
            r10 = 0
            r8[r9] = r10     // Catch:{ all -> 0x00cf }
            int r8 = r7 + -1
            r13.size = r8     // Catch:{ all -> 0x00cf }
            kotlinx.coroutines.internal.Symbol r8 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00cf }
            int r9 = r13.capacity     // Catch:{ all -> 0x00cf }
            if (r7 != r9) goto L_0x0088
        L_0x0031:
            kotlinx.coroutines.channels.AbstractChannel$TryPollDesc r9 = r13.describeTryPoll()     // Catch:{ all -> 0x00cf }
            r10 = r9
            kotlinx.coroutines.internal.AtomicDesc r10 = (kotlinx.coroutines.internal.AtomicDesc) r10     // Catch:{ all -> 0x00cf }
            java.lang.Object r10 = r14.performAtomicTrySelect(r10)     // Catch:{ all -> 0x00cf }
            if (r10 != 0) goto L_0x0052
            java.lang.Object r11 = r9.getResult()     // Catch:{ all -> 0x00cf }
            r0 = r11
            r1 = 1
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x00cf }
            r11 = r0
            kotlinx.coroutines.channels.Send r11 = (kotlinx.coroutines.channels.Send) r11     // Catch:{ all -> 0x00cf }
            java.lang.Object r11 = r11.getPollResult()     // Catch:{ all -> 0x00cf }
            r8 = r11
            goto L_0x0088
        L_0x0052:
            kotlinx.coroutines.internal.Symbol r11 = kotlinx.coroutines.channels.AbstractChannelKt.POLL_FAILED     // Catch:{ all -> 0x00cf }
            if (r10 != r11) goto L_0x0057
            goto L_0x0088
        L_0x0057:
            java.lang.Object r11 = kotlinx.coroutines.internal.AtomicKt.RETRY_ATOMIC     // Catch:{ all -> 0x00cf }
            if (r10 != r11) goto L_0x005c
            goto L_0x0031
        L_0x005c:
            java.lang.Object r11 = kotlinx.coroutines.selects.SelectKt.getALREADY_SELECTED()     // Catch:{ all -> 0x00cf }
            if (r10 != r11) goto L_0x006f
            r13.size = r7     // Catch:{ all -> 0x00cf }
            java.lang.Object[] r11 = r13.buffer     // Catch:{ all -> 0x00cf }
            int r12 = r13.head     // Catch:{ all -> 0x00cf }
            r11[r12] = r2     // Catch:{ all -> 0x00cf }
            r5.unlock()
            return r10
        L_0x006f:
            boolean r11 = r10 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00cf }
            ...
            goto L_0x0088
        L_0x0077:
            java.lang.IllegalStateException r11 = new java.lang.IllegalStateException     // Catch:{ all -> 0x00cf }
            java.lang.String r12 = "performAtomicTrySelect(describeTryOffer) returned "
            java.lang.String r12 = kotlin.jvm.internal.Intrinsics.stringPlus(r12, r10)     // Catch:{ all -> 0x00cf }
            java.lang.String r12 = r12.toString()     // Catch:{ all -> 0x00cf }
        ...
        L_0x0088:
            ...
            boolean r9 = r8 instanceof kotlinx.coroutines.channels.Closed     // Catch:{ all -> 0x00cf }
            if (r9 != 0) goto L_0x009c
            r13.size = r7     // Catch:{ all -> 0x00cf }
            java.lang.Object[] r9 = r13.buffer     // Catch:{ all -> 0x00cf }
            int r10 = r13.head     // Catch:{ all -> 0x00cf }
            int r10 = r10 + r7
            int r11 = r9.length     // Catch:{ all -> 0x00cf }
            int r10 = r10 % r11
            r9[r10] = r8     // Catch:{ all -> 0x00cf }
            goto L_0x00b2
        L_0x009c:
            boolean r9 = r14.trySelect()     // Catch:{ all -> 0x00cf }
            if (r9 != 0) goto L_0x00b2
            r13.size = r7     // Catch:{ all -> 0x00cf }
            java.lang.Object[] r9 = r13.buffer     // Catch:{ all -> 0x00cf }
            int r10 = r13.head     // Catch:{ all -> 0x00cf }
            r9[r10] = r2     // Catch:{ all -> 0x00cf }
        ...
        L_0x00b2:
            int r9 = r13.head     // Catch:{ all -> 0x00cf }
            int r9 = r9 + 1
            java.lang.Object[] r10 = r13.buffer     // Catch:{ all -> 0x00cf }
            int r10 = r10.length     // Catch:{ all -> 0x00cf }
            int r9 = r9 % r10
            r13.head = r9     // Catch:{ all -> 0x00cf }
            kotlin.Unit r6 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00cf }
            r5.unlock()
