...
public final class DelayKt {
    ...
    public static final Object m1722delayVtjQ1oo(long duration, Continuation<? super Unit> $completion) {
        Object delay = delay(m1723toDelayMillisLRDsOJo(duration), $completion);
    ...
    public static final long m1723toDelayMillisLRDsOJo(long $this$toDelayMillis) {
        if (Duration.m1557compareToLRDsOJo($this$toDelayMillis, Duration.Companion.m1660getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m1576getInWholeMillisecondsimpl($this$toDelayMillis), 1);
        }
        return 0;
    }
}
