...
public final class RealBufferedSource implements BufferedSource {
    ...
    public String readUtf8LineStrict(long limit) {
        ...
        if (j >= 0) {
            ...
            if (scanLength$iv < Long.MAX_VALUE && request(scanLength$iv) && this.bufferField.getByte(scanLength$iv - 1) == ((byte) 13) && request(1 + scanLength$iv) && this.bufferField.getByte(scanLength$iv) == b2) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:14:0x0036, code lost:
        ...
        kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r3, "java.lang.Integer.toStri…(this, checkRadix(radix))");
     */
    /* JADX WARNING: Code restructure failed: missing block: B:15:0x0054, code lost:
        throw new java.lang.NumberFormatException(kotlin.jvm.internal.Intrinsics.stringPlus("Expected a digit or '-' but was 0x", r3));
     */
    ...
    public long indexOf(byte b, long fromIndex, long toIndex) {
        ...
        boolean z = true;
        if (!this.closed) {
            if (0 > fromIndex$iv || fromIndex$iv > j) {
                z = false;
            }
            if (z) {
