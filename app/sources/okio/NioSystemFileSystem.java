...
public final class NioSystemFileSystem extends JvmSystemFileSystem {
    public FileMetadata metadataOrNull(Path path) {
        ...
        Long l = null;
        try {
            BasicFileAttributes attributes = Files.readAttributes(nioPath, BasicFileAttributes.class, new LinkOption[]{LinkOption.NOFOLLOW_LINKS});
            ...
            Path path3 = symlinkTarget == null ? null : Path.Companion.get$default(Path.Companion, symlinkTarget, false, 1, (Object) null);
