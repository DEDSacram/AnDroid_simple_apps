...
public final class HashingSink extends ForwardingSink implements Sink {
    ...
    public HashingSink(okio.Sink r6, okio.ByteString r7, java.lang.String r8) {
        /*
            ...
            javax.crypto.Mac r0 = javax.crypto.Mac.getInstance(r8)     // Catch:{ InvalidKeyException -> 0x0034 }
            r1 = r0
            r2 = 0
            javax.crypto.spec.SecretKeySpec r3 = new javax.crypto.spec.SecretKeySpec     // Catch:{ InvalidKeyException -> 0x0034 }
            byte[] r4 = r7.toByteArray()     // Catch:{ InvalidKeyException -> 0x0034 }
            r3.<init>(r4, r8)     // Catch:{ InvalidKeyException -> 0x0034 }
            java.security.Key r3 = (java.security.Key) r3     // Catch:{ InvalidKeyException -> 0x0034 }
            r1.init(r3)     // Catch:{ InvalidKeyException -> 0x0034 }
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ InvalidKeyException -> 0x0034 }
    ...
    public final ByteString m17deprecated_hash() {
        return hash();
    }
