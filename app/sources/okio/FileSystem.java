...
public abstract class FileSystem {
    ...
    public final <T> T m12read(Path file, Function1<? super BufferedSource, ? extends T> readerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
    ...
    public static /* synthetic */ Object m11write$default(FileSystem fileSystem, Path file, boolean mustCreate, Function1 writerAction, int i, Object obj) throws IOException {
        if (obj == null) {
            if ((i & 2) != 0) {
                mustCreate = false;
            }
    ...
    public final <T> T m13write(Path file, boolean mustCreate, Function1<? super BufferedSink, ? extends T> writerAction) throws IOException {
        Intrinsics.checkNotNullParameter(file, "file");
        Intrinsics.checkNotNullParameter(writerAction, "writerAction");
