...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    class Model {
        ...
        private void debugLayout(String title, ConstraintWidgetContainer c) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                String str2 = "_";
                StringBuilder append = new StringBuilder().append(((HttpUrl.FRAGMENT_ENCODE_SET + (child.mTop.mTarget != null ? ExifInterface.GPS_DIRECTION_TRUE : str2)) + (child.mBottom.mTarget != null ? "B" : str2)) + (child.mLeft.mTarget != null ? "L" : str2));
                if (child.mRight.mTarget != null) {
                    str2 = "R";
                }
    ...
    private class DevModeDraw {
        ...
        private void drawPathRelativeTicks(Canvas canvas, float x, float y) {
            ...
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((float) ((int) ((len * 100.0f) / dist))) / 100.0f);
        ...
        private void drawPathCartesianTicks(Canvas canvas, float x, float y) {
            ...
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((float) ((int) (((double) ((xgap * 100.0f) / Math.abs(x2 - x1))) + 0.5d))) / 100.0f);
            getTextBounds(text, this.mTextPaint);
        ...
        private void drawPathScreenTicks(Canvas canvas, float x, float y, int viewWidth, int viewHeight) {
            ...
            float xgap = x;
            float ygap = y;
            String text = HttpUrl.FRAGMENT_ENCODE_SET + (((float) ((int) (((double) (((xgap - ((float) (viewWidth / 2))) * 100.0f) / ((float) (MotionLayout.this.getWidth() - viewWidth)))) + 0.5d))) / 100.0f);
            getTextBounds(text, this.mTextPaint);
