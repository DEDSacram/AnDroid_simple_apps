...
public final /* synthetic */ class CameraController$$ExternalSyntheticLambda3 implements Runnable {
    ...
    public /* synthetic */ CameraController$$ExternalSyntheticLambda3(CameraController cameraController, CameraSelector cameraSelector) {
        this.f$0 = cameraController;
        this.f$1 = cameraSelector;
    }

    public final void run() {
        this.f$0.m197lambda$setCameraSelector$3$androidxcameraviewCameraController(this.f$1);
    }
}
