...
final class ImageAnalysisNonBlockingAnalyzer extends ImageAnalysisAbstractAnalyzer {
    ...
    static class CacheAnalyzingImageProxy extends ForwardingImageProxy {
        ...
        public /* synthetic */ void m140lambda$new$1$androidxcameracoreImageAnalysisNonBlockingAnalyzer$CacheAnalyzingImageProxy(ImageProxy imageProxy) {
            ImageAnalysisNonBlockingAnalyzer analyzer = (ImageAnalysisNonBlockingAnalyzer) this.mNonBlockingAnalyzerWeakReference.get();
            if (analyzer != null) {
                analyzer.mBackgroundExecutor.execute(new ImageAnalysisNonBlockingAnalyzer$CacheAnalyzingImageProxy$$ExternalSyntheticLambda1(analyzer));
            }
        }
    }
}
